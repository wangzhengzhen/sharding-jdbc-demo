...
public class MasterSlaveDataSource {
    ...
    public Map<String, DataSource> createDataSourceMap() {
        ...
        result.put("ds_master", JdbcConfig.createDataSource("ds_master"));
        result.put("ds_slave0", JdbcConfig.createDataSource("ds_slave0"));
        result.put("ds_slave1", JdbcConfig.createDataSource("ds_slave1"));
        return result;
    }
}
